...
import 'package:user_side/views/vehicle_screen/history_upcoming_details_screen.dart';
          ...
          if (state is FetchBookingDataSuccessState) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                BookingModel list = state.upcomingList[index];
                return GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            HistoryUpcomingDetailsScreen(bookingData: list)));
                  },
                  child: Padding(
