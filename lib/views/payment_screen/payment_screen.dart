...
class PaymentScreen extends StatelessWidget {
  ...
  ValueNotifier isChecked = ValueNotifier(false);
  PaymentScreen(
      {super.key,
    ...
    return BlocConsumer<UserBloc, UserState>(
      ...
      builder: (context, state) {
        if (state is FetchUserDataSuccessState) {
          ...
          return paymentScreen(context, vehicle, dpadding, startingDate,
              endingDate, sgst, cgst, isChecked, totalAmount, userModel);
        } else {
          return const Center(
